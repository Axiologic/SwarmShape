    ...
    || (!window.localStorage))
{
    $(document).ready(function(){
        ...
        pageSwitchBrowser.innerHTML = '<div class="contentUnsupported">' +
            ...
            '</div>'+
            '<div class="descriptionUnsuported"><label>You\'re using a web browser we don\'t support.</label><label>Try one of these options to access this aplication.</label></div>'+
            '<ul class="optionList">' +
